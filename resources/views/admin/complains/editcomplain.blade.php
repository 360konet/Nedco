                                        ...
                                        <div class="card">
                                                    ...
                                                    <div class="card-block">
                                                        ...
                                                        <div class="form-group form-default">
                                                                <input type="text" value="{{$editcomplain->user_id}}" name="user_id" class="form-control" required readonly>
                                                            ...
                                                            <div class="form-group form-default">
                                                                <input type="text" name="department" value="{{$editcomplain->department}}" class="form-control" required="">
                                                                <span class="form-bar"></span>
                                                            </div>
                                                    </div>
                                                </div>
